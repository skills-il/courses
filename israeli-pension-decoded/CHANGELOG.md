...
### Hebrew
עדכון תוכן גדול אחרי בדיקת עובדות מול המקורות הרשמיים. תוקנו שש טעויות: תקרת השכר של חובת הפנסיה (אין תקרה של ₪50,695; הבסיס הוא הנמוך מבין השכר הקובע לבין השכר הממוצע), שיעורי ההפקדה (18.5 אחוז בסך הכול, ו-8.33 אחוז הם בחירה של המעסיק ולא חובה), מועד הזכאות לשכיר בלי ביטוח קודם (אחרי שישה חודשים, בלי רטרואקטיביות), חיסכון המס בתקרה בפרק 5, הדוגמה המספרית של פרילנסר, והטענה שאי אפשר לוותר על אף רכיב ביטוחי (על ביטוח שאירים דווקא כן אפשר).

נוספו נושאים שהיו חסרים: תקרת ההפקדה לקרן מקיפה, תקופת אכשרה של חמש שנים למחלות קיימות, גיל הזכאות, מועד העברת הכסף לקרן, והדדליין להסדר ריסק. נוסף גם סעיף "הבהרה משפטית".

### English
A large content update following a fact-check against the official sources. Six errors were corrected: the salary ceiling of the pension mandate (there is no ₪50,695 cap; the base is the lower of your determining salary or the average wage), the contribution rates (18.5 percent in total, with 8.33 percent an employer election rather than a requirement), when an employee with no prior cover becomes entitled (after six months, with no retroactivity), the tax saving at the cap in Chapter 5, the freelancer worked example, and the claim that no insurance component can be waived (survivor cover can be).

Missing material was added: the comprehensive-fund deposit ceiling, the five-year qualifying period for pre-existing conditions, the age of entitlement, the deposit deadline, and the deadline for a risk arrangement. A legal notice section was also added.
...
### Hebrew
שחרור ראשוני של הקורס. שישה פרקים מכסים את מערכת הפנסיה הישראלית עבור שכירים ועצמאים: השלושה־במוצר־אחד, עץ ההחלטה בשתי שאלות, ארבע קרנות ברירת המחדל 2021-2028, איך לקרוא את פנסיה נט, חובת הפנסיה לעצמאים מ־2017 וסולם הטבות המס, ומתי באמת כדאי להחליף קרן. כל הנתונים מעוגנים לשנת 2026.

### English
Initial release. Six chapters covering the Israeli pension system for both employees and self-employed: the three-in-one product, the two-question decision tree, the four 2021-2028 default funds, how to read pensianet, the 2017 self-employed mandate and tax benefit ladder, and when to actually switch funds. All numbers anchored to 2026.
