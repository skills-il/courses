...
### Hebrew
עדכון תוכן גדול אחרי בדיקה מול הפלטפורמות עצמן. פרק 2 נכתב מחדש: באוגוסט 2026 OpenAI סגרה יצירת GPTs חדשים בחשבונות פרטיים, כך שההוראות הקודמות כבר לא היו ניתנות לביצוע. הפרק עובר עכשיו דרך פרויקטים והוראות מותאמות אישית.

בפרק 5 תוקנה הטענה על נתוני האימון של Claude: יש הגדרה שמבקשים מכם לבחור בה, ואם אתם מאפשרים, השמירה מתארכת לחמש שנים. נוספו רשימה מפורשת של מה לא מדביקים לכלי AI, החובות המעשיות של תיקון 13 לחוק הגנת הפרטיות, ושכבת החיסיון המקצועי לעורכי דין ורואי חשבון. לפרק 6 נוסף סעיף על אוטומציה שיוצאת משליטה.

מחירים עודכנו, שמות מודלים מיושנים הוסרו, ונוסף סעיף "הבהרה משפטית". הדוגמאות שייצרו טיוטת חוזה לקורא לא מורשה הוחלפו, כי ניסוח מסמך משפטי עבור אדם אחר שמור בדין לעורך דין.

### English
A large content update following a check against the platforms themselves. Chapter 2 was rewritten: in August 2026 OpenAI closed new GPT creation on personal accounts, so the previous instructions could no longer be followed. The chapter now goes through Projects and custom instructions instead.

In Chapter 5 the claim about Claude's training data was corrected: there is a setting you are asked to choose, and allowing it extends retention to five years. Added: an explicit list of what not to paste into an AI tool, the practical duties under Amendment 13 of the Privacy Protection Law, and the professional-privilege layer for lawyers and accountants. Chapter 6 gained a section on automations that run away with themselves.

Prices were updated, stale model names removed, and a legal notice section added. The examples that produced a contract draft for an unlicensed reader were replaced, because drafting a legal document for another person is reserved by law to a licensed advocate.
